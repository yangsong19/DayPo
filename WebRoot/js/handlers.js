...
function uploadSuccess(file, serverData) {
	try {
		...
		if (serverData === " ") {
			...
			document.getElementById("videoUrl").value = serverData;
			document.getElementById("channel").value = document.getElementById("pcc").options[document.getElementById("pcc").selectedIndex].text;
		}
